This portfolio starter pack is made using React. The data on the portfolio is directly linked to a JSON file. Any changes to the portfolio can be made in the JSON file. The changes will then be reflected on to the portfolio. This allows you to customize your own personal portfolio.
...
```git clone https://github.com/pavan-kumarcn53/My-Portfolio.git```
...
## For your refrence checkout this link https://pavanrockyportfolio.netlify.app/
